    ...
    <div class="bg-white overflow-hidden shadow-xl shadow-slate-600 mb-10 border-2 border-slate-950 w-full">
        ...
        <div class="my-8">
            ...
            <div class="flex flex-wrap items-start justify-center">
                <TableSuaraCaleg v-if="lower_data.table" v-for="calon_data, no_urut in master_calon" :partai="master_partai[no_urut]" :master_calon="calon_data" :calon="calon" :data="lower_data.table[no_urut]"/>
            </div>
        </div>
    </div>
</template>
