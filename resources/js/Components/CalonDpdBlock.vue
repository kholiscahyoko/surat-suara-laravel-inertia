<template>
    <div class="w-32 min-h-[380px] bg-white overflow-hidden shadow-xl shadow-slate-600 m-2 mb-10 border border-2 border-slate-950 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300 cursor-pointer " :id="`calon-${calon.id}`" :class="checkId(calon.id) ? 'bg-yellow-400' : ''">
