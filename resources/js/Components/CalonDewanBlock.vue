<template>
    <div class="block-dewan w-64 lg:min-h-[440px] bg-white overflow-hidden shadow-xl shadow-slate-600 m-2 mb-10 border border-2 border-slate-950  transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300 cursor-pointer">
        ...
        <table class="min-w-full">
            <tbody class="divide-y divide-dashed divide-gray-600">
                <tr v-for="calon in partai.calons">
